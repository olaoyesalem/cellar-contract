...
contract LPTokenWrapper {
    ...
    function stakeFor(address to, uint256 amount) public virtual {
        _totalSupply = _totalSupply.add(amount);
...
contract HakkaRewardsVesting is LPTokenWrapper, IRewardDistributionRecipient {
    ...
    constructor(IERC20 _stakeToken) public {
        ...
        hakka.approve(address(vault), uint256(10000000000000000000000000));
    }
    ...
    function stakeFor(address to, uint256 amount) public override updateReward(to) {
        require(amount > 0, "Cannot stake 0");
...
abstract contract VestingVault {
    function deposit(address to, uint256 amount) external virtual;
}